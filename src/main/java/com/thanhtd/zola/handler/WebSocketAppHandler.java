package com.thanhtd.zola.handler;
...
@Slf4j
public class WebSocketAppHandler implements WebSocketHandler {
//    private static final Logger logger = LoggerFactory.getLogger(WebSocketAppHandler.class);
    @Override
